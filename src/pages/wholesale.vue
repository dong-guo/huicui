  ...
  <div class="wholesale">
    ...
    <div class="show_product">
      ...
      <div class="description">
        <p>A+B款</p>
        <p class="product_price">零售价：19691元</p>
        <p>A+B+C款</p>
        <p class="product_price">零售价：24778元</p>
      </div>
      <div class="price">
    ...
    <div class="content">
      ...
      <div class="free">购买爆款产品，即可参与免单抽奖活动</div>
...
.wholesale {
  ...
  .show_product {
    ...
    .product {
      background: url(../assets/images/bedaimu.png) no-repeat center;
      background-size: 100% 100%;
      width: 66.13vw;
      height: 18.13vw;
      position: absolute;
